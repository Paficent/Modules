...
function Case.Test(Cases) -- Cases is treated as an array where boolean's is the only type allowed, this is because anything in a if statement will get interpreted to be true or false
